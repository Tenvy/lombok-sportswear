    ...
    <>
      ...
      <div className="flex items-center justify-between border-t border-gray-100 px-5 py-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <button className="flex h-9 w-9 items-center justify-center rounded-md bg-black text-[13px] font-bold text-white">
            1
          </button>
          {[2, 3, 4].map((n) => (
            <button
              key={n}
              className="flex h-9 w-9 items-center justify-center rounded-md border border-gray-200 text-[13px] font-medium text-gray-500 transition-colors hover:border-gray-400 hover:text-black"
            >
              {n}
            </button>
          ))}
          <span className="px-0.5 text-[13px] text-gray-300">...</span>
          <button className="flex h-9 w-9 items-center justify-center rounded-md border border-gray-200 text-[13px] font-medium text-gray-500 transition-colors hover:border-gray-400 hover:text-black">
            6
          </button>
          <button className="flex h-9 w-9 items-center justify-center rounded-md border border-gray-200 text-gray-400 transition-colors hover:border-gray-400 hover:text-black">
            <CaretRight size={14} />
